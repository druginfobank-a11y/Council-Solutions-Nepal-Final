...
const Settings: React.FC = () => {
  ...
  const handleOpenLegal = (url: string | undefined, type: string) => {
    if (url) {
      window.open(ensureExternalLink(url), '_blank');
    } else {
      alert(`The ${type} link has not been configured in the system node yet.`);
    }
  };
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4 pt-4">
          ...
          <div className="flex gap-2">
             <button onClick={() => handleOpenLegal(sysConfig.privacyPolicyUrl, 'Privacy Policy')} className="flex-1 py-4 bg-slate-50 dark:bg-slate-950 hover:bg-blue-50 dark:hover:bg-blue-900/10 rounded-xl text-[9px] font-black uppercase dark:text-slate-400 transition-all">Privacy Policy</button>
             <button onClick={() => handleOpenLegal(sysConfig.termsOfServiceUrl, 'Terms of Use')} className="flex-1 py-4 bg-slate-50 dark:bg-slate-950 hover:bg-blue-50 dark:hover:bg-blue-900/10 rounded-xl text-[9px] font-black uppercase dark:text-slate-400 transition-all">Terms of Use</button>
          </div>
        </div>
      </div>
