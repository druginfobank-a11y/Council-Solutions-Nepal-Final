...
const Plans: React.FC<PlansProps> = ({ user }) => {
  ...
  const handleSubmitPayment = async () => {
    ...
    if (!selectedPlan) { setSyncError("Logic Fault: Subscription tier not selected."); return; }
    ...
    try {
      ...
      alert("Evidence Transmission Successful: Logic Hub will verify within 1-2 cycles.");
